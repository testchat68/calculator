...
PINK      = "#F4A8C0"   # операции
CREAM     = "#F4E8C8"   # фон навсякъде
TEAL      = "#4EB8B4"   # памет
RED       = "#D32F2F"   # C, ⌫, ±
KEY_NUM   = "#8EC9C2"   # цифри
KEY_SOFT  = "#F98F98"   # √ и %
SCREEN_BG = "#1e1e1e"
DIGIT_FG  = "#7FE8B0"
WHITE     = "#FFFFFF"
HOVER     = "#2C5A56"   # тъмно петролно при посочване
...
class Calculator:
    ...
    def create_widgets(self):
        ...
        self.make_btn(buttons_frame, "C",   0, 0, RED,      fg=WHITE)
        self.make_btn(buttons_frame, "⌫",   0, 1, RED,      fg=WHITE)
        ...
        self.make_btn(buttons_frame, "±",   4, 4, RED,      fg=WHITE)
