...
class Calculator:
    ...
    def create_widgets(self):
        ...
        self.make_btn(buttons_frame, "C",   0, 0, PINK,     fg=WHITE)
        self.make_btn(buttons_frame, "⌫",   0, 1, PINK,     fg=WHITE)
        self.make_btn(buttons_frame, "√",   0, 2, KEY_DIM,  fg=WHITE)
        self.make_btn(buttons_frame, "÷",   0, 3, MUSTARD,  fg=WHITE)
        ...
        self.make_btn(buttons_frame, "×",   1, 3, MUSTARD,  fg=WHITE)
        ...
        self.make_btn(buttons_frame, "−",   2, 3, MUSTARD,  fg=WHITE)
        ...
        self.make_btn(buttons_frame, "+",   3, 3, MUSTARD,  fg=WHITE)
        ...
        self.make_btn(buttons_frame, "%",   4, 2, KEY_DIM,  fg=WHITE)
        self.make_btn(buttons_frame, "=",   4, 3, MUSTARD,  fg=WHITE)
        self.make_btn(buttons_frame, "±",   4, 4, PINK,     fg=WHITE)
    ...
    def make_btn(self, parent, text, row, col, color, small=False, fg="white"):
        ...
        pressed = self._darken(color)
        btn = tk.Button(
            parent, text=text, font=font, bg=color, fg=fg,
            activebackground=pressed, activeforeground=WHITE,
            relief="raised", bd=2,
            command=lambda t=text: self.on_button_click(t),
        )
        btn.grid(row=row, column=col, sticky="nsew", padx=3, pady=3, ipady=10)
        btn.bind("<Enter>", lambda e, b=btn, c=pressed: b.config(bg=c))
